function GoogleButton({ onClick, disabled, label = 'Continue with Google' }) {
  return (
    <button
      ...
      onClick={onClick}
      disabled={disabled}
      className="flex w-full items-center justify-center gap-3 rounded-full border border-charcoal/15 bg-warm-white px-6 py-3 text-sm font-medium text-charcoal transition-colors hover:border-forest/40 disabled:opacity-60"
    >
